...
if schema is None:
    ...
    # *.yaml files under surfvis.parser will be loaded automatically
    ...
    tmp = configuratt.load_nested(files,
                                  ...
                                  config_class="SurfvisCabs",
                                  use_cache=False)

    # tmp is a tuple containing the config object as the first element
    # and a set containing locations of .yaml configs for surfvis workers
